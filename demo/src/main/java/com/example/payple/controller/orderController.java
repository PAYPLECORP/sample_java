...
public class orderController  {
	...
	public String order_confirm(HttpServletRequest request, Model model) {
		...
		model.addAttribute("pay_method_flag", request.getParameter("pay_method_flag")); // 결제 수단 (appCard|naverPay|kakaoPay)
	...
	public String order_result(HttpServletRequest request, Model model) {
		...
		model.addAttribute("pay_method", request.getParameter("PCD_PAY_METHOD")); 				// 결제 수단 (appCard|naverPay|kakaoPay)
		model.addAttribute("easy_pay_method", request.getParameter("PCD_EASY_PAY_METHOD")); 	// 간편결제 수단
		...
		model.addAttribute("tx_key", request.getParameter("PCD_TX_KEY")); 						// 거래 키
